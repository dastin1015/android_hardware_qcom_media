...
libmm-vdec-inc          += $(ANDROID_BUILD_TOP)/$(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr/include
...
LOCAL_ADDITIONAL_DEPENDENCIES  := $(ANDROID_BUILD_TOP)/$(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr
...
mm-vdec-test-inc    += $(ANDROID_BUILD_TOP)/$(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr/include
...
mm-vdec-drv-test-inc    += $(ANDROID_BUILD_TOP)/$(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr/include
